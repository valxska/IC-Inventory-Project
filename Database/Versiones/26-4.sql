...
CREATE TABLE IF NOT EXISTS `Inventario_IC`.`History` (
  ...
  INDEX `fk_History_Person2_idx` (`BorrowIdPerson` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_History_Person1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_History_Person2`
    FOREIGN KEY (`BorrowIdPerson`)
    REFERENCES `Inventario_IC`.`Person` (`idPerson`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sys`.`innodb_lock_waits` (`wait_started` INT, `wait_age` INT, `wait_age_secs` INT, `locked_table` INT, `locked_table_schema` INT, `locked_table_name` INT, `locked_table_partition` INT, `locked_table_subpartition` INT, `locked_index` INT, `locked_type` INT, `waiting_trx_id` INT, `waiting_trx_started` INT, `waiting_trx_age` INT, `waiting_trx_rows_locked` INT, `waiting_trx_rows_modified` INT, `waiting_pid` INT, `waiting_query` INT, `waiting_lock_id` INT, `waiting_lock_mode` INT, `blocking_trx_id` INT, `blocking_pid` INT, `blocking_query` INT, `blocking_lock_id` INT, `blocking_lock_mode` INT, `blocking_trx_started` INT, `blocking_trx_age` INT, `blocking_trx_rows_locked` INT, `blocking_trx_rows_modified` INT, `sql_kill_blocking_query` INT, `sql_kill_blocking_connection` INT);
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`create_synonym_db`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`diagnostics`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`execute_prepared_stmt`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`format_statement`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`list_add`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`list_drop`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`ps_is_account_enabled`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`ps_is_consumer_enabled`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`ps_is_instrument_default_enabled`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`ps_is_instrument_default_timed`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`ps_is_thread_instrumented`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_disable_background_threads`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_disable_consumer`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_disable_instrument`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_disable_thread`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_enable_background_threads`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_enable_consumer`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_enable_instrument`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_enable_thread`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_reload_saved`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_reset_to_default`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_save`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_show_disabled`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_show_disabled_consumers`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_show_disabled_instruments`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_show_enabled`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_show_enabled_consumers`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_setup_show_enabled_instruments`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_statement_avg_latency_histogram`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`ps_thread_account`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_trace_statement_digest`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_trace_thread`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`ps_truncate_all_tables`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`statement_performance_analyzer`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`sys_get_config`;
...
USE `sys`;
DROP procedure IF EXISTS `sys`.`table_exists`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`version_major`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`version_minor`;
...
USE `sys`;
DROP function IF EXISTS `sys`.`version_patch`;
...
DROP VIEW IF EXISTS `sys`.`host_summary_by_stages` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`innodb_lock_waits` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`io_by_thread_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`io_global_by_file_by_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`io_global_by_file_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`io_global_by_wait_by_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`io_global_by_wait_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`latest_file_io` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`schema_auto_increment_columns` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`schema_index_statistics` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`schema_table_statistics_with_buffer` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`schema_tables_with_full_table_scans` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`schema_unused_indexes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`session` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`session_ssl_status` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`statements_with_errors_or_warnings` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`statements_with_full_table_scans` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`statements_with_runtimes_in_95th_percentile` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`statements_with_sorting` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`statements_with_temp_tables` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`user_summary_by_stages` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`waits_by_user_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`waits_global_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$host_summary_by_stages` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$host_summary_by_statement_latency` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$host_summary_by_statement_latency` (`host`,`total`,`total_latency`,`max_latency`,`lock_latency`,`rows_sent`,`rows_examined`,`rows_affected`,`full_scans`) AS select if(isnull(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) AS `host`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,max(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME`) AS `lock_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT`) AS `rows_sent`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED`) AS `rows_examined`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED`) AS `rows_affected`,(sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED`) + sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`)) AS `full_scans` from `performance_schema`.`events_statements_summary_by_host_by_event_name` group by if(isnull(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) order by sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) desc;

-- -----------------------------------------------------
-- View `sys`.`x$host_summary_by_statement_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$host_summary_by_statement_type`;
DROP VIEW IF EXISTS `sys`.`x$host_summary_by_statement_type` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$innodb_buffer_stats_by_schema` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$innodb_buffer_stats_by_schema` (`object_schema`,`allocated`,`data`,`pages`,`pages_hashed`,`pages_old`,`rows_cached`) AS select if((locate('.',`ibp`.`TABLE_NAME`) = 0),'InnoDB System',replace(substring_index(`ibp`.`TABLE_NAME`,'.',1),'`','')) AS `object_schema`,sum(if((`ibp`.`COMPRESSED_SIZE` = 0),16384,`ibp`.`COMPRESSED_SIZE`)) AS `allocated`,sum(`ibp`.`DATA_SIZE`) AS `data`,count(`ibp`.`PAGE_NUMBER`) AS `pages`,count(if((`ibp`.`IS_HASHED` = 'YES'),1,NULL)) AS `pages_hashed`,count(if((`ibp`.`IS_OLD` = 'YES'),1,NULL)) AS `pages_old`,round(ifnull((sum(`ibp`.`NUMBER_RECORDS`) / nullif(count(distinct `ibp`.`INDEX_NAME`),0)),0),0) AS `rows_cached` from `information_schema`.`INNODB_BUFFER_PAGE` `ibp` where (`ibp`.`TABLE_NAME` is not null) group by `object_schema` order by sum(if((`ibp`.`COMPRESSED_SIZE` = 0),16384,`ibp`.`COMPRESSED_SIZE`)) desc;

-- -----------------------------------------------------
-- View `sys`.`x$innodb_buffer_stats_by_table`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$innodb_buffer_stats_by_table`;
DROP VIEW IF EXISTS `sys`.`x$innodb_buffer_stats_by_table` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$innodb_lock_waits` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$io_by_thread_by_latency` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$io_by_thread_by_latency` (`user`,`total`,`total_latency`,`min_latency`,`avg_latency`,`max_latency`,`thread_id`,`processlist_id`) AS select if(isnull(`performance_schema`.`threads`.`PROCESSLIST_ID`),substring_index(`performance_schema`.`threads`.`NAME`,'/',-(1)),concat(`performance_schema`.`threads`.`PROCESSLIST_USER`,'@',`performance_schema`.`threads`.`PROCESSLIST_HOST`)) AS `user`,sum(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,min(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`MIN_TIMER_WAIT`) AS `min_latency`,avg(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`AVG_TIMER_WAIT`) AS `avg_latency`,max(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency`,`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID` AS `thread_id`,`performance_schema`.`threads`.`PROCESSLIST_ID` AS `processlist_id` from (`performance_schema`.`events_waits_summary_by_thread_by_event_name` left join `performance_schema`.`threads` on((`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID` = `performance_schema`.`threads`.`THREAD_ID`))) where ((`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`EVENT_NAME` like 'wait/io/file/%') and (`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT` > 0)) group by `performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID`,`performance_schema`.`threads`.`PROCESSLIST_ID`,`user` order by sum(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT`) desc;

-- -----------------------------------------------------
-- View `sys`.`x$io_global_by_file_by_bytes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$io_global_by_file_by_bytes`;
DROP VIEW IF EXISTS `sys`.`x$io_global_by_file_by_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$io_global_by_file_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$io_global_by_wait_by_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$io_global_by_wait_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$latest_file_io` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$memory_by_host_by_current_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$memory_by_thread_by_current_bytes` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$memory_by_thread_by_current_bytes` (`thread_id`,`user`,`current_count_used`,`current_allocated`,`current_avg_alloc`,`current_max_alloc`,`total_allocated`) AS select `t`.`THREAD_ID` AS `thread_id`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',`t`.`PROCESSLIST_HOST`),replace(`t`.`NAME`,'thread/','')) AS `user`,sum(`mt`.`CURRENT_COUNT_USED`) AS `current_count_used`,sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_allocated`,ifnull((sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) / nullif(sum(`mt`.`CURRENT_COUNT_USED`),0)),0) AS `current_avg_alloc`,max(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_max_alloc`,sum(`mt`.`SUM_NUMBER_OF_BYTES_ALLOC`) AS `total_allocated` from (`performance_schema`.`memory_summary_by_thread_by_event_name` `mt` join `performance_schema`.`threads` `t` on((`mt`.`THREAD_ID` = `t`.`THREAD_ID`))) group by `t`.`THREAD_ID`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',`t`.`PROCESSLIST_HOST`),replace(`t`.`NAME`,'thread/','')) order by sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) desc;

-- -----------------------------------------------------
-- View `sys`.`x$memory_by_user_by_current_bytes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$memory_by_user_by_current_bytes`;
DROP VIEW IF EXISTS `sys`.`x$memory_by_user_by_current_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$memory_global_by_current_bytes` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$schema_table_lock_waits` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$schema_table_lock_waits` (`object_schema`,`object_name`,`waiting_thread_id`,`waiting_pid`,`waiting_account`,`waiting_lock_type`,`waiting_lock_duration`,`waiting_query`,`waiting_query_secs`,`waiting_query_rows_affected`,`waiting_query_rows_examined`,`blocking_thread_id`,`blocking_pid`,`blocking_account`,`blocking_lock_type`,`blocking_lock_duration`,`sql_kill_blocking_query`,`sql_kill_blocking_connection`) AS select `g`.`OBJECT_SCHEMA` AS `object_schema`,`g`.`OBJECT_NAME` AS `object_name`,`pt`.`THREAD_ID` AS `waiting_thread_id`,`pt`.`PROCESSLIST_ID` AS `waiting_pid`,`sys`.`ps_thread_account`(`p`.`OWNER_THREAD_ID`) AS `waiting_account`,`p`.`LOCK_TYPE` AS `waiting_lock_type`,`p`.`LOCK_DURATION` AS `waiting_lock_duration`,`pt`.`PROCESSLIST_INFO` AS `waiting_query`,`pt`.`PROCESSLIST_TIME` AS `waiting_query_secs`,`ps`.`ROWS_AFFECTED` AS `waiting_query_rows_affected`,`ps`.`ROWS_EXAMINED` AS `waiting_query_rows_examined`,`gt`.`THREAD_ID` AS `blocking_thread_id`,`gt`.`PROCESSLIST_ID` AS `blocking_pid`,`sys`.`ps_thread_account`(`g`.`OWNER_THREAD_ID`) AS `blocking_account`,`g`.`LOCK_TYPE` AS `blocking_lock_type`,`g`.`LOCK_DURATION` AS `blocking_lock_duration`,concat('KILL QUERY ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_query`,concat('KILL ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_connection` from (((((`performance_schema`.`metadata_locks` `g` join `performance_schema`.`metadata_locks` `p` on(((`g`.`OBJECT_TYPE` = `p`.`OBJECT_TYPE`) and (`g`.`OBJECT_SCHEMA` = `p`.`OBJECT_SCHEMA`) and (`g`.`OBJECT_NAME` = `p`.`OBJECT_NAME`) and (`g`.`LOCK_STATUS` = 'GRANTED') and (`p`.`LOCK_STATUS` = 'PENDING')))) join `performance_schema`.`threads` `gt` on((`g`.`OWNER_THREAD_ID` = `gt`.`THREAD_ID`))) join `performance_schema`.`threads` `pt` on((`p`.`OWNER_THREAD_ID` = `pt`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `gs` on((`g`.`OWNER_THREAD_ID` = `gs`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `ps` on((`p`.`OWNER_THREAD_ID` = `ps`.`THREAD_ID`))) where (`g`.`OBJECT_TYPE` = 'TABLE');

-- -----------------------------------------------------
-- View `sys`.`x$schema_table_statistics`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$schema_table_statistics`;
DROP VIEW IF EXISTS `sys`.`x$schema_table_statistics` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$schema_table_statistics_with_buffer` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$schema_table_statistics_with_buffer` (`table_schema`,`table_name`,`rows_fetched`,`fetch_latency`,`rows_inserted`,`insert_latency`,`rows_updated`,`update_latency`,`rows_deleted`,`delete_latency`,`io_read_requests`,`io_read`,`io_read_latency`,`io_write_requests`,`io_write`,`io_write_latency`,`io_misc_requests`,`io_misc_latency`,`innodb_buffer_allocated`,`innodb_buffer_data`,`innodb_buffer_free`,`innodb_buffer_pages`,`innodb_buffer_pages_hashed`,`innodb_buffer_pages_old`,`innodb_buffer_rows_cached`) AS select `pst`.`OBJECT_SCHEMA` AS `table_schema`,`pst`.`OBJECT_NAME` AS `table_name`,`pst`.`COUNT_FETCH` AS `rows_fetched`,`pst`.`SUM_TIMER_FETCH` AS `fetch_latency`,`pst`.`COUNT_INSERT` AS `rows_inserted`,`pst`.`SUM_TIMER_INSERT` AS `insert_latency`,`pst`.`COUNT_UPDATE` AS `rows_updated`,`pst`.`SUM_TIMER_UPDATE` AS `update_latency`,`pst`.`COUNT_DELETE` AS `rows_deleted`,`pst`.`SUM_TIMER_DELETE` AS `delete_latency`,`fsbi`.`count_read` AS `io_read_requests`,`fsbi`.`sum_number_of_bytes_read` AS `io_read`,`fsbi`.`sum_timer_read` AS `io_read_latency`,`fsbi`.`count_write` AS `io_write_requests`,`fsbi`.`sum_number_of_bytes_write` AS `io_write`,`fsbi`.`sum_timer_write` AS `io_write_latency`,`fsbi`.`count_misc` AS `io_misc_requests`,`fsbi`.`sum_timer_misc` AS `io_misc_latency`,`ibp`.`allocated` AS `innodb_buffer_allocated`,`ibp`.`data` AS `innodb_buffer_data`,(`ibp`.`allocated` - `ibp`.`data`) AS `innodb_buffer_free`,`ibp`.`pages` AS `innodb_buffer_pages`,`ibp`.`pages_hashed` AS `innodb_buffer_pages_hashed`,`ibp`.`pages_old` AS `innodb_buffer_pages_old`,`ibp`.`rows_cached` AS `innodb_buffer_rows_cached` from ((`performance_schema`.`table_io_waits_summary_by_table` `pst` left join `sys`.`x$ps_schema_table_statistics_io` `fsbi` on(((`pst`.`OBJECT_SCHEMA` = `fsbi`.`table_schema`) and (`pst`.`OBJECT_NAME` = `fsbi`.`table_name`)))) left join `sys`.`x$innodb_buffer_stats_by_table` `ibp` on(((`pst`.`OBJECT_SCHEMA` = convert(`ibp`.`object_schema` using utf8mb4)) and (`pst`.`OBJECT_NAME` = convert(`ibp`.`object_name` using utf8mb4))))) order by `pst`.`SUM_TIMER_WAIT` desc;

-- -----------------------------------------------------
-- View `sys`.`x$schema_tables_with_full_table_scans`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$schema_tables_with_full_table_scans`;
DROP VIEW IF EXISTS `sys`.`x$schema_tables_with_full_table_scans` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$session` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$statement_analysis` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$statements_with_errors_or_warnings` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$statements_with_full_table_scans` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$statements_with_runtimes_in_95th_percentile` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$statements_with_sorting` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$statements_with_temp_tables` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$user_summary` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$user_summary` (`user`,`statements`,`statement_latency`,`statement_avg_latency`,`table_scans`,`file_ios`,`file_io_latency`,`current_connections`,`total_connections`,`unique_hosts`,`current_memory`,`total_memory_allocated`) AS select if(isnull(`performance_schema`.`accounts`.`USER`),'background',`performance_schema`.`accounts`.`USER`) AS `user`,sum(`stmt`.`total`) AS `statements`,sum(`stmt`.`total_latency`) AS `statement_latency`,ifnull((sum(`stmt`.`total_latency`) / nullif(sum(`stmt`.`total`),0)),0) AS `statement_avg_latency`,sum(`stmt`.`full_scans`) AS `table_scans`,sum(`io`.`ios`) AS `file_ios`,sum(`io`.`io_latency`) AS `file_io_latency`,sum(`performance_schema`.`accounts`.`CURRENT_CONNECTIONS`) AS `current_connections`,sum(`performance_schema`.`accounts`.`TOTAL_CONNECTIONS`) AS `total_connections`,count(distinct `performance_schema`.`accounts`.`HOST`) AS `unique_hosts`,sum(`mem`.`current_allocated`) AS `current_memory`,sum(`mem`.`total_allocated`) AS `total_memory_allocated` from (((`performance_schema`.`accounts` left join `sys`.`x$user_summary_by_statement_latency` `stmt` on((if(isnull(`performance_schema`.`accounts`.`USER`),'background',`performance_schema`.`accounts`.`USER`) = `stmt`.`user`))) left join `sys`.`x$user_summary_by_file_io` `io` on((if(isnull(`performance_schema`.`accounts`.`USER`),'background',`performance_schema`.`accounts`.`USER`) = `io`.`user`))) left join `sys`.`x$memory_by_user_by_current_bytes` `mem` on((if(isnull(`performance_schema`.`accounts`.`USER`),'background',`performance_schema`.`accounts`.`USER`) = `mem`.`user`))) group by if(isnull(`performance_schema`.`accounts`.`USER`),'background',`performance_schema`.`accounts`.`USER`) order by sum(`stmt`.`total_latency`) desc;

-- -----------------------------------------------------
-- View `sys`.`x$user_summary_by_file_io`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$user_summary_by_file_io`;
DROP VIEW IF EXISTS `sys`.`x$user_summary_by_file_io` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$user_summary_by_file_io_type` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$user_summary_by_stages` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$user_summary_by_statement_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$user_summary_by_statement_type` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$wait_classes_global_by_avg_latency` ;
USE `sys`;
CREATE  OR REPLACE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$wait_classes_global_by_avg_latency` (`event_class`,`total`,`total_latency`,`min_latency`,`avg_latency`,`max_latency`) AS select substring_index(`performance_schema`.`events_waits_summary_global_by_event_name`.`EVENT_NAME`,'/',3) AS `event_class`,sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,min(`performance_schema`.`events_waits_summary_global_by_event_name`.`MIN_TIMER_WAIT`) AS `min_latency`,ifnull((sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`) / nullif(sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`COUNT_STAR`),0)),0) AS `avg_latency`,max(`performance_schema`.`events_waits_summary_global_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency` from `performance_schema`.`events_waits_summary_global_by_event_name` where ((`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT` > 0) and (`performance_schema`.`events_waits_summary_global_by_event_name`.`EVENT_NAME` <> 'idle')) group by `event_class` order by ifnull((sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`) / nullif(sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`COUNT_STAR`),0)),0) desc;

-- -----------------------------------------------------
-- View `sys`.`x$wait_classes_global_by_latency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sys`.`x$wait_classes_global_by_latency`;
DROP VIEW IF EXISTS `sys`.`x$wait_classes_global_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$waits_by_host_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$waits_by_user_by_latency` ;
USE `sys`;
...
DROP VIEW IF EXISTS `sys`.`x$waits_global_by_latency` ;
USE `sys`;
...
USE `sys`$$
DROP TRIGGER IF EXISTS `sys`.`sys_config_insert_set_user` $$
USE `sys`$$
CREATE
...
USE `sys`$$
DROP TRIGGER IF EXISTS `sys`.`sys_config_update_set_user` $$
USE `sys`$$
CREATE
DEFINER=`mysql.sys`@`localhost`
